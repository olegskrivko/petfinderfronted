...
// //   //     if (existingSubscription) {
// //   //       // You might want to compare with backend too, if needed
...
//       }
//     } catch (error) {
//       console.error("Exception saving subscription to backend:", error);
//     }
//   };
...
//         setSubscription(null);
//       } else {
//         console.error("Error unsubscribing from backend:", await response.text());
//       }
//     } catch (error) {
...
//         console.log("Backend has no record of subscription. Resending...");
