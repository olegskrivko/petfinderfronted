...
// import FacebookIcon from '@mui/icons-material/Facebook';
// import InstagramIcon from '@mui/icons-material/Instagram';
// import collaborateImage from './images/creative_team_amico.svg'; // Replace with your actual image
...
//           Mēs ticam, ka kopīga sadarbība var padarīt mūsu platformu vēl labāku! Ja esat dzīvnieku patversme, veterinārā klīnika, tehnoloģiju uzņēmums vai vienkārši kaislīgs dzīvnieku mīļotājs, mēs labprāt uzklausītu jūsu idejas.
//           </Typography>
//           Mēs esam atvērti dažāda veida partnerībām, tostarp:
...
// Ja jums ir idejas vai vēlme sadarboties, sazinieties ar mums! Kopā mēs varam radīt drošāku un atbalstošāku vidi mājdzīvnieku īpašniekiem.
//           {/* Contact Form */}
// add here link to contacts or to feedback form. feedback form have topic colobration
//         </Grid>
//       </Grid>
      ...
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            <strong>Mēs esam atvērti dažāda veida partnerībām:</strong>
          </Typography>
